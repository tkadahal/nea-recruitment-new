    ...
    Route::group(['prefix' => 'admin', 'as' => 'admin.'], function () {
        Route::group(['namespace' => 'Admin'], function () {
            ...
            Route::delete(
                ...
                action: 'PermissionController@massDestroy'
            )->name(name: 'permissions.massDestroy');
            Route::resource(name: 'permission', controller: PermissionController::class);

            // Roles
            Route::delete(
                uri: 'roles/destroy',
                action: 'RoleController@massDestroy'
            )->name(name: 'roles.massDestroy');
            Route::resource(name: 'role', controller: RoleController::class);

            // Admin Users
            Route::delete(
                uri: 'admins/destroy',
                action: 'AdminController@massDestroy'
            )->name(name: 'admins.massDestroy');
            ...
            Route::delete(
                ...
                action: 'ProvinceController@massDestroy'
            )->name(name: 'provinces.massDestroy');
            Route::resource(
                name: 'province',
            ...
            // Districts
            Route::delete(
                uri: 'districts/destroy',
                action: 'DistrictController@massDestroy'
            )->name(name: 'districts.massDestroy');
            Route::resource(
                name: 'district',
            ...
            // Municipalities
            Route::delete(
                uri: 'municipalities/destroy',
                action: 'MunicipalityController@massDestroy'
            )->name(name: 'municipalities.massDestroy');
            Route::resource(
                name: 'municipality',
            ...
            // Fiscal Year
            Route::delete(
                uri: 'fiscalYears/destroy',
                action: 'FiscalYearController@massDestroy'
            )->name(name: 'fiscalYears.massDestroy');
            Route::resource(
                name: 'fiscalYear',
            ...
            // Countries
            Route::delete(
                uri: 'countries/destroy',
                action: 'CountryController@massDestroy'
            )->name(name: 'countries.massDestroy');
            Route::resource(
                name: 'country',
            ...
            Route::delete(
                uri: 'genders/destroy',
                action: 'GenderController@massDestroy'
            )->name(name: 'genders.massDestroy');
            Route::resource(
                name: 'gender',
            ...
            // Media Types
            Route::delete(
                uri: 'mediaTypes/destroy',
                action: 'MediaTypeController@massDestroy'
            )->name(name: 'mediaTypes.massDestroy');
            Route::resource(
                name: 'mediaType',
                controller: MediaTypeController::class
            );

            // Qualifications
            Route::delete(
                uri: 'qualifications/destroy',
                action: 'QualificationController@massDestroy'
            )->name(name: 'qualifications.massDestroy');
            Route::resource(
                name: 'qualification',
            ...
            // Univeristies
            Route::delete(
                uri: 'universities/destroy',
                action: 'UniversityController@massDestroy'
            )->name(name: 'universities.massDestroy');
            Route::resource(
                name: 'university',
            ...
            // Divisions
            Route::delete(
                uri: 'divisions/destroy',
                action: 'DivisionController@massDestroy'
            )->name(name: 'divisions.massDestroy');
            Route::resource(
                name: 'division',
            ...
            // Recruitment Types
            Route::delete(
                uri: 'recruitmentTypes/destroy',
                action: 'RecruitmentTypeController@massDestroy'
            )->name(name: 'recruitmentTypes.massDestroy');
            Route::resource(
                name: 'recruitmentType',
                controller: RecruitmentTypeController::class
            );

            // Sewas
            Route::delete(
                uri: 'categories/destroy',
                action: 'CategoryController@massDestroy'
            )->name(name: 'categories.massDestroy');
            Route::resource(
                name: 'category',
            ...
            Route::delete(
                uri: 'groups/destroy',
                action: 'GroupController@massDestroy'
            )->name(name: 'groups.massDestroy');
            Route::resource(
                name: 'group',
            ...
            // Sub Groups
            Route::delete(
                uri: 'subGroups/destroy',
                action: 'SubGroupController@massDestroy'
            )->name(name: 'subGroups.massDestroy');
            Route::resource(
                name: 'subGroup',
            ...
            Route::delete(
                uri: 'levels/destroy',
                action: 'LevelController@massDestroy'
            )->name(name: 'levels.massDestroy');
            Route::resource(
                name: 'level',
            ...
            Route::delete(
                ...
                action: 'PositionController@massDestroy'
            )->name(name: 'positions.massDestroy');
            Route::resource(
                name: 'position',
            ...
            // Designations
            Route::delete(
                uri: 'designations/destroy',
                action: 'DesignationController@massDestroy'
            )->name(name: 'designations.massDestroy');
            Route::resource(
                name: 'designation',
            ...
            // Samabeshi Groups
            Route::delete(
                uri: 'samabeshiGroups/destroy',
                action: 'SamabeshiGroupController@massDestroy'
            )->name(name: 'samabeshiGroups.massDestroy');
            Route::resource(
                name: 'samabeshiGroup',
                controller: SamabeshiGroupController::class
            );

            // Application Fees
            Route::delete(
                uri: 'applicationFees/destroy',
                action: 'ApplicationFeeController@massDestroy'
            )->name(name: 'applicationFees.massDestroy');
            Route::resource(
                name: 'applicationFee',
                controller: ApplicationFeeController::class
            );

            // Exam Center
            Route::delete(
                uri: 'examCenters/destroy',
                action: 'ExamCenterController@massDestroy'
            )->name(name: 'examCenters.massDestroy');
            Route::resource(
                name: 'examCenter',
            ...
            Route::delete(
                uri: 'advertisements/destroy',
                action: 'AdvertisementController@massDestroy'
            )->name(name: 'advertisements.massDestroy');
            Route::resource(
                name: 'advertisement',
