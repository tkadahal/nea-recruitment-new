...
return [
    ...
    'advertisement' => [
        ...
        'fields' => [
            ...
            'experience_calculation_period' => 'Experience Calculation Period (in Months)',
            ...
            'samabeshi_groups' => 'Samabeshi Groups',
    ...
    'support' => [
        ...
        'title_singular' => 'Help and Support',
        'fields' => [
            'id' => 'ID',
            'id_helper' => '',
            'title' => 'Question',
            ...
            'description' => 'Answer',
            'description_helper' => '',
            'question_by' => 'Question Raised By',
            'question_by_helper' => '',
    ...
    'personal' => [
        ...
        'info' => [
            ...
            'appointmentInfo' => '***Required for NEA Staffs',
            'appointmentMaxInfo' => '***Allowed file size is 5MB or below ( JPG/JPEG or PDF ).',
            'recommendationInfo' => '***Required for NEA Staffs',
            'recommendationMaxInfo' => '***Allowed file size is 5MB or below ( JPG/JPEG or PDF ).',
        ],
        'fields' => [
            'id' => 'ID',
            'id_helper' => '',
    ...
    'application' => [
        ...
        'info' => [
            ...
            'desinationNotFoundInfo' => 'Please select appropirate gender.',
            'experienceInfo' => '***Experience for this application will only be calculated if your individual experience is greater than :experienceCalculationPeriod months',
            'trainingPeriodInfo' => 'Oops !!! Looks like your training period doesnot meet the training requirement for this application.',
            'experiencePeriodInfo' => 'Oops !!! Looks like your experience period doesnot meet the experience requirement for this application.',
        ],
        'dropdowns' => [
