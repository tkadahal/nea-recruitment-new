                            ...
                            <div class="row g-3 m-3">
                                        ...
                                        <div class="custom-radio-buttons" data-toggle="buttons">
                                            @foreach ($genders as $id => $title)
                                                <label
                                                    ...
                                                    <input class="radio-button" type="radio" name="gender_id"
                                                        id="{{ $id }}" autocomplete="off"
                                                        value="{{ $id }}"
                                                        {{ old('gender_id') == $id || (isset($personal) && $personal->gender_id == $id) ? 'checked' : '' }}>
                                                    <i class="fas fa-sharp fa-solid fa-check-circle"
                                                        style="color: #fff"></i>
                                                    {{ $title }}
                                                </label>
                                            @endforeach
                                ...
                                <div class="col-md-6">
                                    <div class="form-group {{ $errors->has('dob_en') ? 'has-error' : '' }}">
                                        ...
                                        <div class="input-group">
                                            <input type="text" id="dob_en" name="dob_en"
                            ...
                            <div class="row g-3 m-3">
                                ...
                                <div class="col-md-4">
                                    <div
                                        ...
                                        <div class="input-group">
                                            <input type="text" id="citizenship_issued_date"
                                                name="citizenship_issued_date" class="form-control nepali-calendar"
                                    ...
                                    <div
                                        ...
                                        <select name="citizenship_district_id" id="citizenship_district_id"
                                            ...
                                            @foreach ($citizenshipDistricts as $id => $citizenshipDistrict)
                                                <option value="{{ $id }}"
                                                    {{ (isset($personal) && $personal->citizenshipDistrict
