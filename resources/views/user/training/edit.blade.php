...
@section('content')
    <div class="card-body {{ request()->routeIs('training') ? 'active' : '' }}" id="training">
                    ...
                    <div class="row g-3 m-3">
                            ...
                            <div class="radio-buttons">
                                <label>
                                    <input type="radio" name="date_format" value="BS"
                                        {{ isset($training) && $training->date_format == 'BS' ? 'checked' : '' }}>
                                    {{ trans('global.training.fields.bs') }}
                                </label>
                                <label>
                                    <input type="radio" name="date_format" value="AD"
                                        {{ isset($training) && $training->date_format == 'AD' ? 'checked' : '' }}>
                        ...
                        <div class="row">
                            ...
                            <div class="col-6 d-flex justify-content-end" style="align-items: center;">
                                @if (isset($training) && $training->media->where('media_type_id', 8)->isNotEmpty())
                                    <a target="_blank"
