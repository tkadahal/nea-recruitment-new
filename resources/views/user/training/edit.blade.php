                        ...
                        <div class="row g-3 m-3">
                            ...
                            <div class="row">
                                <div class="radio-buttons">
                                    <label>
                                        <input type="radio" name="date_format" value="BS" {{ isset($training) &&
                                            $training->date_format == 'BS' ? 'checked' : '' }}>
                                        {{ trans('global.training.fields.bs') }}
                                    </label>
                                    <label>
                                        <input type="radio" name="date_format" value="AD" {{ isset($training) &&
                                            $training->date_format == 'AD' ? 'checked' : '' }}>
                            ...
                            <div class="col-md-6">
                                <div class="form-group {{ $errors->has('training_from') ? 'has-error' : '' }}">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="hidden" id="ad_training_from" name="ad_training_from"
                                            value="{{ old('training_to', isset($training) ? $training->ad_training_from : '') }}">
                                    </div>
                            ...
                            <div class="col-md-6">
                                <div class="form-group {{ $errors->has('training_to') ? 'has-error' : '' }}">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <i class="date-icon fa fa-calendar" aria-hidden="true"></i>
                                        <input type="hidden" id="ad_training_to" name="ad_training_to"
                                            value="{{ old('training_to', isset($training) ? $training->ad_training_to : '') }}">
                                    </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-6 d-flex justify-content-end" style="align-items: center;">
                                    @if (isset($training) && $training->media->where('media_type_id',
                                    8)->isNotEmpty())
                                    <a target="_blank"
                                        href="{{ $training->media->where('media_type_id', 8)->first()->short_url }}"
                                        style="display: flex; align-items: center;">
                                        <i class="fas fa-file-pdf fa-3x text-primary" aria-hidden="true"></i>
                                        <input type="hidden" name="old_certificate"
                                            value="{{ $training->media->where('media_type_id', 8)->first()->short_url }}">
                                    </a>
                                    @endif
                                </div>
                            </div>
