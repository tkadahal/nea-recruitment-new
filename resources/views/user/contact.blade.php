                                    ...
                                    <div class="card-section mt-3">
                                        ...
                                        <div class="row g-1 m-0">
                                            ...
                                            <div
                                                ...
                                                <select name="perma_province" id="perma_province"
                                            ...
                                            <div
                                                ...
                                                <select name="perma_district" id="perma_district"
                                                    class="form-control select2">
                                            ...
                                            <div
                                                class="col-md-12 form-group {{ $errors->has('perma_tol') ? 'has-error' : '' }}">
                                    ...
                                    <div class="card-section mt-3">
                                        ...
                                        <div class="row g-1 m-0">
                                            <div
                                                ...
                                                <select name="temp_province" id="temp_province"
                                                    class="form-control select2">
                                            ...
                                            <div
                                                ...
                                                <select name="temp_district" id="temp_district"
                                                    class="form-control select2">
                                            ...
                                            <div
                                                class="col-md-12 form-group {{ $errors->has('temp_tol') ? 'has-error' : '' }}">
                                                <label class="required" for="temp_tol">
                                                    {{ trans('global.contact.fields.temp_tol') }}
                                                </label>
                                                <input type="text" id="temp_tol" name="temp_tol"
                                                    class="form-control"
                    ...
                    <div class="card-section">
                        ...
                        <div class="p3">
                            <div class="row g-2 m-3">
                                ...
                                <div class="col-md-6">
                                    <div
                                        class="form-group {{ $errors->has('contact_person_number') ? 'has-error' : '' }}">
