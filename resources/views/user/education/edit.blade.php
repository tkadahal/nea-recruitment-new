...
@section('content')
    <div class="card-body {{ request()->routeIs('education') ? 'active' : '' }}" id="education">
            ...
            <div class="card-section">
                ...
                <div class="p3">
                    ...
                    <div class="row g-3 m-3">
                        ...
                        <div class="row">
                            <div class="col-md-4">
                                <div class="form-group {{ $errors->has('transcript_issue_date') ? 'has-error' : '' }}">
                                    ...
                                    <div class="radio-buttons">
                                        <label>
                                            <input type="radio" name="date_format" value="BS"
                                                {{ isset($education) && $education->date_format == 'BS' ? 'checked' : '' }}>
                                            {{ trans('global.education.fields.bs') }}
                                        </label>
                                        <label>
                                            <input type="radio" name="date_format" value="AD"
                                                {{ isset($education) && $education->date_format == 'AD' ? 'checked' : '' }}>
                        ...
                        <div class="row">
                                ...
                                <div class="form-group {{ $errors->has('transcript') ? 'has-error' : '' }}">
                                    ...
                                    <p>
                                        <span style="color: #b60bef;">
                                            {{ trans('global.education.category.info.documentInfo') }}
                                        </span>
                                    </p>
                            ...
                            <div class="col-6 d-flex justify-content-end">
                                @if (isset($education) && $education->media->where('media_type_id', 7)->isNotEmpty())
                                    <a target="_blank"
                        ...
                        <div class="row">
                            ...
                            <div class="col-6 d-flex justify-content-end">
                                @if (isset($education) && $education->media->where('media_type_id', 6)->isNotEmpty())
                                    <a target="_blank"
                            ...
                            <div class="col-6">
                                <p class="pb-1">
                                    <span class="text-danger">
                                        <b>{{ trans('global.education.category.info.councilInfo') }}</b>
                                    </span>
                                </p>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6" id="equivalence-field"
                                ...
                                <p class="pb-1">
                                    <span class="text-danger">
                                        <b>{{ trans('global.education.category.info.equivalenceInfo') }}</b>
                                    </span>
                                </p>
