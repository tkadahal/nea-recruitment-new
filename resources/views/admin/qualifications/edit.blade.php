...
<div class="card">
    <form class="form-horizontal" action="{{ route('admin.qualification.update', $qualification) }}" method="POST"
        ...
        <div class="card-header">
            ...
            {{ trans('global.edit') }} {{ trans('global.qualification.title_singular') }}
        </div>
        <div class="card-body">
