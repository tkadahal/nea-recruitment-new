...
@section('content')
    <div class="form-group d-flex justify-content-between">
        ...
        <div class="d-flex align-items-center">
            @if (!$payment->paymentVerification || $payment->paymentVerification->is_checked == 0)
            ...
            @if (
                $payment->paymentVerification &&
                    $payment->paymentVerification->is_checked == 1 &&
                    $payment->paymentVerification->is_approved != 1)
                <form method="POST" action="{{ route('admin.paymentVerification.store') }}" class="d-inline-block">
                    @csrf
            ...
            @endif
            @if (isset($payment->paymentVerification) &&
                    $payment->paymentVerification->is_rejected == 0 &&
                    $payment->paymentVerification->is_approved != 1)
                <form method="POST" action="{{ route('admin.paymentVerification.store') }}" class="d-inline-block">
                    @csrf
