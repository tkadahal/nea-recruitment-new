...
<div class="form-group d-flex justify-content-between">
    ...
    <div class="d-flex align-items-center">
        @if (!$payment->paymentVerification || ($payment->paymentVerification->is_checked === false)) ||
        ($payment->paymentVerification->is_rejected === false && $payment->paymentVerification->if_approved === false)
        ...
        @if (!isset($payment->paymentVerification) || !$payment->paymentVerification->is_rejected)
        <form method="POST" action="{{ route('admin.paymentVerification.store') }}" class="d-inline-block">
            @csrf
        ...
        $payment->paymentVerification &&
        $payment->paymentVerification->is_checked == true &&
        $payment->paymentVerification->is_approved != true &&
        $payment->paymentVerification->is_rejected != true
        )
        <form method="POST" action="{{ route('admin.paymentVerification.store') }}" class="d-inline-block">
            @csrf
