                ...
                <table class="table table-bordered table-striped table-hover datatable datatable-subGroup">
                    <thead>
                        <tr>
                            ...
                            <th>
                                {{ trans('global.subGroup.fields.category_id') }}
                            </th>
                            <th>
                            ...
                            <tr data-entry-id="{{ $subGroup->id }}">
                                ...
                                <td>
                                    <div class="btn-group" role="group" aria-label="subGroup Functions">
                                        ...
                                        @can('subGroup_show')
                                            <a href="{{ route('admin.subGroup.show', $subGroup) }}"
                                        ...
                                        @can('subGroup_edit')
                                            <a href="{{ route('admin.subGroup.edit', $subGroup) }}"
...
@section('scripts')
    ...
    <script>
        $(function() {
            ...
            $('.datatable-subGroup:not(.ajaxTable)').DataTable({
                buttons: dtButtons
            })
