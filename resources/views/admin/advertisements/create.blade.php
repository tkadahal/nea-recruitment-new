                ...
                <div class="p-2">
                    <div class="row g-3">
                        <div class="col-md-4 form-group {{ $errors->has('fiscal_year_id') ? 'has-error' : '' }}">
                            ...
                            <select name="fiscal_year_id" id="fiscal_year_id" class="form-control select2">
                                ...
                                <option value="{{ $id }}" {{ (isset($advertisement) && $advertisement->fiscalYear
                        ...
                        <div class="col-md-4 form-group {{ $errors->has('exam_center_id') ? 'has-error' : '' }}">
                            ...
                            <select name="exam_center_id" id="exam_center_id" class="form-control select2">
                                ...
                                <option value="{{ $id }}" {{ (isset($advertisement) && $advertisement->examCenter
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4 form-group {{ $errors->has('end_date_np') ? 'has-error' : '' }}">
                            ...
                            <input type="text" id="end_date_np" name="end_date_np" class="form-control nepali-calendar"
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4 form-group {{ $errors->has('group_id') ? 'has-error' : '' }}">
                            ...
                            <select name="group_id" id="group_id" class="form-control select2">
                                ...
                                <option value="{{ $id }}" {{ (isset($advertisement) && $advertisement->group ?
                                    $advertisement->group->id : old('group_id')) == $id
                                    ? 'selected'
                                    : '' }}>
                                    {{ $group }}
                                </option>
                        ...
                        <div class="col-md-4 form-group {{ $errors->has('sub_group_id') ? 'has-error' : '' }}">
                            ...
                            <select name="sub_group_id" id="sub_group_id" class="form-control select2">
                                ...
                                <option value="{{ $id }}" {{ (isset($advertisement) && $advertisement->subGroup ?
                                    $advertisement->subGroup->id : old('sub_group_id')) == $id
                                    ? 'selected'
                                    : '' }}>
                                    {{ $subGroup }}
                                </option>
                        ...
                        <div class="col-md-4 form-group {{ $errors->has('level_id') ? 'has-error' : '' }}">
                            ...
                            <select name="level_id" id="level_id" class="form-control select2">
                                ...
                                <option value="{{ $id }}" {{ (isset($advertisement) && $advertisement->level ?
                                    $advertisement->level->id : old('level_id')) == $id
                                    ? 'selected'
                                    : '' }}>
                                    {{ $level }}
                                </option>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4 form-group {{ $errors->has('designation_id') ? 'has-error' : '' }}">
                            ...
                            <select name="designation_id" id="designation_id" class="form-control select2">
                                ...
                                <option value="{{ $id }}" {{ (isset($advertisement) && $advertisement->designation ?
                                    $advertisement->designation->id : old('designation_id')) ==
                                    $id
                                    ? 'selected'
                                    : '' }}>
                                    {{ $designation }}
                        ...
                        <div class="col-md-4 form-group {{ $errors->has('qualification_id') ? 'has-error' : '' }}">
                            ...
                            <select name="qualification_id" id="qualification_id" class="form-control select2">
                                ...
                                <option value="{{ $id }}" {{ (isset($advertisement) && $advertisement->qualification
                        ...
                        <div class="col-md-4 form-group {{ $errors->has('experience_period') ? 'has-error' : '' }}">
                            ...
                            <input type="number" id="experience_period" name="experience_period" class="form-control"
                    ...
                    <div class="col-md-4">
                        ...
                        <div class="form-check">
                            <input class="form-check-input" type="checkbox" value="{{ $id }}" id="{{ $id }}"
                                name="samabeshi_groups[]" @if(old('samabeshi_groups') && isset($advertisement) &&
                                $advertisement->samabeshiGroups->contains($id))
                            checked @endif>
            ...
            if (groupId) {
                $.ajax({
                    ...
                    , success: function(data) {
                        $('#sub_group_id').empty().append('<option value="">' + "{{ trans('global.pleaseSelect') }}" + '</option>');
