                        ...
                        <div class="col-md-4 form-group {{ $errors->has('category_id') ? 'has-error' : '' }}">
                            ...
                            <select name="category_id" id="category_id" class="form-control select2">
                                ...
                                <option value="{{ $id }}" {{ (isset($advertisement) && $advertisement->category ?
                                    $advertisement->category->id : old('category_id')) ==
                                    $id
                                    ? 'selected'
                                    : '' }}>
                                    {{ $category }}
                        ...
                        <div class="col-md-4 form-group {{ $errors->has('sub_group_id') ? 'has-error' : '' }}">
                            ...
                            <select name="sub_group_id" id="sub_group_id" class="form-control select2">
                                ...
                                <option value="{{ $id }}" {{ (isset($advertisement) && $advertisement->subGroup ?
                                    $advertisement->subGroup->id : old('sub_group_id')) ==
                                    $id
                                    ? 'selected'
                                    : '' }}>
                                    {{ $subGroup }}
                    ...
                    <div class="col-md-4">
                        ...
                        <div class="form-check" style="margin-bottom: 10px;">
                            <input class="form-check-input" type="checkbox" value="{{ $samabeshiGroup['id'] }}"
                                id="{{ $samabeshiGroup['id'] }}" name="samabeshi_groups[]" style="width: 20px; height: 20px;
                                border: var(--bs-border-width) solid #0d0d0d;" @if ($samabeshiGroup['applied']) checked
                                @endif>
