                    ...
                    <tr data-entry-id="{{ $district->id }}">
                        ...
                        <td>
                            <div class="btn-group" role="group" aria-label="district Functions">
                                ...
                                @can('district_show')
                                <a href="{{ route('admin.district.show', $district) }}" class="btn btn-primary btn-sm">
                                    {{ trans('global.show') }}
                                </a>
                                @endcan

                                @can('district_edit')
                                <a href="{{ route('admin.district.edit', $district) }}" class="btn btn-info btn-sm">
                                    {{ trans('global.edit') }}
                                </a>
                                @endcan
...
@endcan
  ...
  $('.datatable-district:not(.ajaxTable)').DataTable({ buttons: dtButtons })
