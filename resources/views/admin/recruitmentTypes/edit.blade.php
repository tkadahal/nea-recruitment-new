...
<div class="card">
    <form class="form-horizontal" action="{{ route('admin.recruitmentType.update', $recruitmentType) }}" method="POST"
        ...
        <div class="card-header">
            ...
            {{ trans('global.edit') }} {{ trans('global.recruitmentType.title_singular') }}
        </div>
        <div class="card-body">
